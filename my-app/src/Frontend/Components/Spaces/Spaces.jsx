    ...
    <QuoraHeader/>
      <div style={{ backgroundColor: "#e6e7e8" }}>
        <div style={{ display: "flex",  gap: "10px" }}>
          <div style={{marginTop:'40px', width: "30%" }}></div>
            ...
            <div style={{lineHeight:'3'}}>
              ...
              >
                <div style={gridChildStyle}>
                  ...
                  <p style={{ padding:'8px',font: "small-caption" }}>
                ...
                <div style={gridChildStyle}>
                  ...
                  <h5>&nbsp;&nbsp;Memekaze</h5>
                  <p style={{ padding:'8px',font: "small-caption" }}>Memes</p>
                </div>
                <div style={gridChildStyle}>
                  <img
                    style={{ borderRadius: "20px 20px 0 0" }}
          ...
          <div style={{marginTop:'40px', width: "40%" }}>
            <div>
              <div
                style={{
                  width: "200px",
              ...
              >
                <h4 style={{ padding: "15px 0 15px 0" }}> Pending Invites</h4>
                <hr />
