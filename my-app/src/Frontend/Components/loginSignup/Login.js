        ...
        <div>
          ...
          <p id="sloganPTag">
            {english
              ...
              : "ज्ञान बाँटने और दुनिया को बेहतर ढंग से समझने की एक अनोखी जगह"}
          </p>
          <div id="loginBox">
            ...
            <input
              ...
              type="email"
              placeholder={english ? "Your email" : "आपका ईमेल"}
            />

            <p className="aboveInputBoxPTag">
              {english ? "Password" : "पासवर्ड"}
            </p>
            ...
            <input
              ...
              className="loginInputBox"
              type="password"
              placeholder={english ? "Your password" : "आपका पासवर्ड"}
            />

            <button onClick={loginUser} id="logInButton">
              {english ? "Log In" : "लॉग इन करें"}
            </button>

            <p onClick={alternateBoxes} id="createNewAccountPTag">
              {english ? "create new account" : "नया खाता बनाएँ"}
            </p>
          </div>
          ...
          <div id="signupBox">
            ...
            <input
              ...
              id="nameSignup"
              className="loginInputBox"
              placeholder={english ? "Your name" : "आपका नाम"}
            />
            <p id="nameWarning" className="signupWarning">
              {english ? "*name is too small" : "*नाम बहुत छोटा है"}
            </p>
            ...
            <p className="aboveInputBoxPTag">
              {english ? "Create Password" : "पासवर्ड बनाएं"}
            </p>
            ...
            <input
              ...
              type="password"
              placeholder={
                english ? "Create your password" : "अपना पासवर्ड बनाएं"
              }
            />
            <p id="passwordWarning" className="signupWarning">
              {english
                ? "*this email is already registered"
                : "*पासवर्ड में कम से कम आठ अक्षर होने चाहिए"}
            </p>

            <button onClick={storeUser} id="signupButton">
              {english ? "Sign Up" : "साइन अप करें"}
            </button>

            <p onClick={alternateBoxes} id="alreadyHaveAnAccountPTag">
              {english ? "already have an account? Sign in" : "दाखिल करना"}
            </p>
          </div>
        </div>
