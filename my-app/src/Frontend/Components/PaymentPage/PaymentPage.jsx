  ...
  return (
    <div className="container">
      <div className="popup">
        ...
        >
          <img
            src="https://qph.cf2.quoracdn.net/main-thumb-860644095-200-rkyticcrkietpvouqkowdtwsmnakyoop.jpeg"
            style={{
              width: "100px",
              height: "80px",
              borderRadius: "50%",
        ...
        >
          ...
          >
            ...
            >
              <path
                d="M6.36523 6.77881L6.36994 6.78217V17.404C6.39605 17.4925 6.51951 17.8425 6.92779 18.0366C7.50475 18.3109 8.07202 18.288 8.0845 18.2878L8.08392 7.09292C8.08392 7.09292 7.11624 7.09129 6.36523 6.77881Z"
                class="icon_svg-fill_as_stroke"
                fill="#666666"
              ></path>
              <path
                d="M14.4324 11.9689C14.4324 11.2904 13.8824 10.7406 13.204 10.7407C12.5256 10.7408 11.9756 11.291 11.9756 11.9694C11.9756 12.4336 12.2331 12.8376 12.613 13.0464L12.1734 15.2C12.1585 15.2732 12.2144 15.3416 12.289 15.3415L14.1188 15.341C14.1935 15.341 14.2493 15.2726 14.2344 15.1995L13.7948 13.046C14.1748 12.8372 14.4324 12.433 14.4324 11.9689Z"
                class="icon_svg-fill_as_stroke"
                fill="#666666"
              ></path>
              <path
                d="M16.4575 7.09181V5.40625L8.0918 7.09181H16.4575Z"
                class="icon_svg-fill_as_stroke"
                fill="#666666"
              ></path>
              <path
                d="M12 -0.0170898C5.37254 -0.0170898 0 5.35545 0 11.9829C0 18.6104 5.37254 23.9829 12 23.9829C18.6275 23.9829 24 18.6104 24 11.9829C24 5.35545 18.6275 -0.0170898 12 -0.0170898ZM18.3237 7.09286V18.9907H16.6694H8.21923L8.21914 18.9908H8.08253C8.05085 18.9908 7.27613 19.0037 6.48058 18.5929C5.69818 18.1889 5.67619 17.5052 5.67619 17.5052V6.27926L14.6698 4.59091C14.6698 4.59091 14.8125 4.9176 15.4404 5.0808C16.4397 5.34048 17.1545 5.26541 17.1545 5.26541V7.09142H18.3235V7.09286H18.3237Z"
                class="icon_svg-fill_as_stroke"
                fill="#666666"
              ></path>
            </svg>
            <p>Unlock millions of answers</p>
          </div>
          <div
            className="box_3"
            style={{
          ...
          <TableContainer>
            <Table variant="simple">
              ...
              <Tbody>
                ...
                <Tr>
                  <Td>
                    Your subscription will renew automatically each year. Cancel
        ...
        <div className="Last_para">
          <p className="parag_raph">
            Existing subscriptions will also be charged to this card. You may
            receive a temporary authorization charge to validate your card.
            Learn more.
          </p>
        </div>
