              ...
              >
                <g stroke="#666" fill="none">
                  <g transform="translate(9 7)">
                    <path d="M3 6v-.5A2.5 2.5 0 1 0 .5 3"></path>
                    <circle
                      fill="#666"
                      cx="3"
                      cy="8.5"
                  ...
                  <path d="M7.5 4h9a3 3 0 0 1 3 3v9a3 3 0 0 1-3 3h-3L9 22v-3H7.5a3 3 0 0 1-3-3V7a3 3 0 0 1 3-3Z"></path>
                </g>
              </svg>
            </div>
            <div className="quoraText" style={textStyle}>
              Ask
            </div>
            <Modal
              open={isModalOpen}
