    ...
    <div className='postHead'>
      ...
      <div className='content'>
        <div className='content-up'>
            ...
            <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill='none'><path d="m16.243 7.757-8.486 8.486m8.486 0L7.757 7.757"     stroke="#666" ></path></svg>
            </div>
        </div>
